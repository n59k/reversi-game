...
public class UserController {
    ...
    public String login(@RequestParam String login, @RequestParam String password, Model model) {
        ...
        if (user == null) {
            if (login.isEmpty()) {
                model.addAttribute("error", "    <div id=\"myDiv\" class=\"fixed bottom-5 mx-auto flex justify-center\">\n" +
                ...
                model.addAttribute("error", "    <div id=\"myDiv\" class=\"fixed bottom-5 mx-auto flex justify-center\">\n" +
                        ...
                        "                  </svg>\n" +
                        "                </span>\n" +
                        "                    <span class=\"text-sm leading-5 text-red-50 font-medium ml-3\">Please enter your password!</span>\n" +
                        "                </div>\n" +
                        "            </div>\n" +
                        "        </div>\n" +
                        "    </div>");
            ...
            if (password.isEmpty()) {
                ...
                model.addAttribute("error", "    <div id=\"myDiv\" class=\"fixed bottom-5 mx-auto flex justify-center\">\n" +
                        ...
                        "                  </svg>\n" +
                        "                </span>\n" +
                        "                    <span class=\"text-sm leading-5 text-red-50 font-medium ml-3\">The password is wrong!</span>\n" +
                        "                </div>\n" +
                        "            </div>\n" +
                        "        </div>\n" +
                        "    </div>");
